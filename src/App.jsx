...
function TaktoLogo({ size = 26 }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 9, userSelect: "none" }}>
      <div style={{ width: size * 1.3, height: size * 1.3, background: G, borderRadius: size * 0.3, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
        <svg width={size * 0.62} height={size * 0.62} viewBox="0 0 24 24" fill="white"><path d="M12 2l2.5 7.7L22 12l-7.5 2.3L12 22l-2.5-7.7L2 12l7.5-2.3L12 2z" /></svg>
      </div>
      <span style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: size, letterSpacing: "-0.03em", color: "var(--t)" }}>Takto</span>
    </div>
  );
}
